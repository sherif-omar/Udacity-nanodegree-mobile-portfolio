...
var pizzaElementGenerator = function(i) {
    ...
    pizzaImage.src = "images/pizza-min.png"; //changed file to compressed version.
...
var resizePizzas = function(size) {
    ...
    // window.performance.clearMeasures('measure_pizza_resize'); //added cide per Piazza info. Looks like you need it to work this right, but I am not sure.
...
var pizzasDiv = document.getElementById("randomPizzas"); //moved out of the loop to improve performance.
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
    ...
    var itemsLength = items.length; // improve performance by calculating items.length once and not several times in a loop.
    var phase = Math.sin((document.body.scrollTop / 1250) + (itemsLength % 5)); //changed i to itemslength as it is not in the loop. See above.
    for (var i = 0; i < itemsLength; i++) { //see note above
